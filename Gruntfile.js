module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    pkgMeta: grunt.file.readJSON('umbraco-package'),
    dest: grunt.option('target') || 'dist',
    basePath: path.join('<%= dest %>', 'App_Plugins', 'SirTrevor'),
    ...
    watch: {
      ...
      less: {
        files: ['src/App_Plugins/SirTrevor/*.less'],
        tasks: ['less:dist']
      },

      js: {
        files: ['src/App_Plugins/SirTrevor/*.js'],
        tasks: ['concat:dist']
      },

      html: {
        files: ['src/App_Plugins/SirTrevor/*.html'],
        tasks: ['copy:html']
      },
